...
The app automatically reads FBR-Value-Karachi-2022.xlsx and parses category rate tables and area-wise valuation categories. Built with a practical flow: Address Input → FBR Area Name → Category → Rate → Final Valuation.`,
    ...
    {
        title: "gikihub",
        summary: "An all-access digital portal designed for students to navigate campus life at GIKI effortlessly.",
        stack: ["HTML", "CSS", "JavaScript"],
        repo: "https://github.com/hamziAli/gikihub",
        demo: "https://github.com/hamziAli/gikihub",
        description: "A comprehensive student platform connecting campus services, mess schedules, structural ratings, transport links, and interactive community-driven event management dashboards.",
        features: [
            "Centralized Campus Dashboard connecting essential utilities, transport portals, and academic landmarks",
            "Community-facing Social Event Management pipeline allowing student crowd updates and dynamic item tracking.",
            "Moderated Admin Verification panel backed by client credential validation for secure content filtering.",
            "Interactive Mess Menu featuring localized dining schedules and client-side crowd-sourced dish rating tools",
        ],
        screenshot: "/GIKIHUB PIC.png",
        videoUrl: "/Video Project 2.mp4",
    },
    {
        title: "Battleship",
